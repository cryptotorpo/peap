...
var d = function (c, e, t, o) {
  ...
  if (typeof Reflect == "object" && typeof Reflect.decorate == "function")
    ...
    for (var l = c.length - 1; l >= 0; l--)
      (s = c[l]) && (i = (a < 3 ? s(i) : a > 3 ? s(e, t, i) : s(e, t)) || i);
...
let n = class extends b {
  constructor() {
    super(),
      ...
      y.sendEvent({ type: "track", event: "MODAL_LOADED" });
  }
  ...
  async handleClose() {
    w.state.view === "UnsupportedChain" || (await u.isSIWXCloseDisabled())
      ? r.shake()
      : r.close();
  }
  initializeTheming() {
    const { themeVariables: e, themeMode: t } = N.state,
      o = g.getColorTheme(t);
    C(e, o);
  }
  onClose() {
  ...
  onScrollUnlock() {
    const e = document.head.querySelector(`style[data-w3m="${p}"]`);
    e && e.remove();
  }
  ...
  async onNewAddress(e) {
    ...
    (this.caipAddress = e), await u.initializeIfEnabled(), t || r.close();
  }
  onNewNetwork(e) {
    var a, i, s, l;
    if (!this.caipAddress) {
      (this.caipNetwork = e), w.goBack();
      return;
    }
    const t =
        (i = (a = this.caipNetwork) == null ? void 0 : a.caipNetworkId) == null
          ...
          : i.toString(),
      o =
        (s = e == null ? void 0 : e.caipNetworkId) == null
          ? void 0
          : s.toString();
    t &&
      o &&
      t !== o &&
      ((l = this.caipNetwork) == null ? void 0 : l.name) !==
        "Unknown Network" &&
      w.goBack(),
      (this.caipNetwork = e);
  }
...
n.styles = S;
d([m()], n.prototype, "open", void 0);
d([m()], n.prototype, "caipAddress", void 0);
d([m()], n.prototype, "caipNetwork", void 0);
d([m()], n.prototype, "shake", void 0);
n = d([A("w3m-modal")], n);
export { n as W3mModal };
